...
public class Exam6_1 {
  public static void main(String[] args) {
    ...
    // 즉 arr1을 위에 선언 해주면 arr1 int[5]에 맞는 인스턴스 주소를 생성하는데
    // 이를 arr2 = arr1로 arr2에 arr1 int[5]의 주소를 넣는다.
    // 따라서 arr2[0] 번째 주소에 300을 넣어도 arr1[0]과 arr2[0]의 주소가 같아서
    // arr1[0]번째의 주소 값도 300이 된다.

    // 조금 쉽게 이해하기.
    // arr1 집주소를 선언 arr1 집 주소에 100의 값을 넣어놨다.
    // arr2 집주소를 arr1 집 주소와 동일하다고 arr2 = arr1 설정
    // arr2 집 주소에 300의 값을 넣어둠.
    // arr1의 집 주소와 arr2의 주소가 같기 때문에 300의 값이 나온다.
    System.out.println(arr1[0]);
    arr2[0] = 300;
    System.out.println(arr1[0]);
    ...
    // int a;
    // System.out.println(a); 의 값은 컴파일 되지 않는다.
    // 이유는 a의 값을 정의하지 않았기 때문이다.
    // 
