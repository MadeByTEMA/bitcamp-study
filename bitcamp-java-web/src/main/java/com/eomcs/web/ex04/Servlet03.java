...
/*
 * POST /java-web/ex04/s3 HTTP/1.1 Host: localhost:8080 Connection: keep-alive
 * Content-Length: 57 Pragma: no-cache Cache-Control: no-cache Origin:
 ...
 * Referer: http://localhost:8080/java-web/ex04/test03.html Accept-Encoding:
