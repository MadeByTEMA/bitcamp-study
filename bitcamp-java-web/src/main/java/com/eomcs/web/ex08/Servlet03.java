...
public class Servlet03 extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    // => 리다이렉트 HTTP 응답 프로토콜
    /*
     * HTTP/1.1 302 <----- 리다이렉트 응답 상태 코드 Location: s100 <----- 리다이렉트 URL
     * Content-Type: text/html;charset=UTF-8 Content-Length: 0 Date: Tue, 02 Apr
     * 2019 03:38:45 GMT 빈 줄 <---- 콘텐트를 보내지 않는다. 즉 message-body가 없다.
     */
